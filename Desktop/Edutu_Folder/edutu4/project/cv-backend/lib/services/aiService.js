...
class AIService {
    constructor() {
        this.provider = process.env.AI_SERVICE_PROVIDER || 'anthropic';
        if (this.provider === 'anthropic' && process.env.ANTHROPIC_API_KEY) {
            ...
            logger_1.logger.warn('No AI service configured, using mock responses');
        }
    }
    /**
     * Analyze and optimize CV content
     */
    async optimizeCV(cvText, jobDescription, industry, targetRole) {
        const startTime = Date.now();
        try {
            logger_1.logger.info('Starting CV optimization', {
            ...
            throw new errors_1.AIServiceError('Failed to optimize CV', this.provider);
        }
    }
    /**
     * Perform ATS compatibility analysis
     */
    async analyzeATSCompatibility(cvText, jobDescription) {
        const startTime = Date.now();
        try {
            logger_1.logger.info('Starting ATS analysis', {
                textLength: cvText.length,
                hasJobDescription: !!jobDescription
            });
            ...
            logger_1.logger.info('ATS analysis completed', {
                duration: Date.now() - startTime,
            ...
            logger_1.logger.error('ATS analysis failed', {
                duration: Date.now() - startTime,
                error: error instanceof Error ? error.message : 'Unknown error'
            });
            throw new errors_1.AIServiceError('Failed to analyze ATS compatibility', this.provider);
        }
    }
    /**
     * Generate industry-specific CV suggestions
     */
    async getIndustryTips(industry, role, experience) {
        try {
      ...
      Return as a JSON array of strings.`;
            ...
            logger_1.logger.error('Industry tips generation failed', { industry, role, error });
            return this.getMockIndustryTips(industry, role);
        }
    }
    /**
    ...
    async callAnthropic(prompt) {
        if (!this.anthropic) {
            throw new errors_1.AIServiceError('Anthropic client not initialized');
        }
        try {
            ...
            if (response.content[0].type === 'text') {
                ...
                throw new errors_1.AIServiceError('Unexpected response format from Anthropic');
            }
        }
        catch (error) {
            logger_1.logger.error('Anthropic API call failed', { error });
            throw new errors_1.AIServiceError('Failed to call Anthropic API', 'anthropic');
        }
    }
    /**
     * Call OpenAI API
    ...
    async callOpenAI(prompt) {
        if (!this.openai) {
            throw new errors_1.AIServiceError('OpenAI client not initialized');
        }
        try {
            ...
            throw new errors_1.AIServiceError('Failed to call OpenAI API', 'openai');
        }
    }
    /**
     * Build optimization prompt
     */
    buildOptimizationPrompt(cvText, jobDescription, industry, targetRole) {
        return `
...
`;
     ...
     */
    buildATSPrompt(cvText, jobDescription) {
        return `
...
`;
     ...
     */
    parseOptimizationResponse(response, originalText) {
        ...
        try {
            ...
            return {
                ...
                keywordAnalysis: {
                    currentKeywords: ((_a = parsed.keywordAnalysis) === null || _a === void 0 ? void 0 : _a.currentKeywords) || [],
                    missingKeywords: ((_b = parsed.keywordAnalysis) === null || _b === void 0 ? void 0 : _b.missingKeywords) || [],
                    keywordDensity: ((_c = parsed.keywordAnalysis) === null || _c === void 0 ? void 0 : _c.keywordDensity) || {}
                },
                structuralAnalysis: {
                    sectionsFound: ((_d = parsed.structuralAnalysis) === null || _d === void 0 ? void 0 : _d.sectionsFound) || [],
                    missingSections: ((_e = parsed.structuralAnalysis) === null || _e === void 0 ? void 0 : _e.missingSections) || [],
                    sectionOrder: ((_f = parsed.structuralAnalysis) === null || _f === void 0 ? void 0 : _f.sectionOrder) || [],
                    lengthAnalysis: {
                        wordCount: originalText.split(/\s+/).length,
                        recommendedRange: ((_h = (_g = parsed.structuralAnalysis) === null || _g === void 0 ? void 0 : _g.lengthAnalysis) === null || _h === void 0 ? void 0 : _h.recommendedRange) || '400-600 words',
                        isOptimal: ((_k = (_j = parsed.structuralAnalysis) === null || _j === void 0 ? void 0 : _j.lengthAnalysis) === null || _k === void 0 ? void 0 : _k.isOptimal) || false
                    }
                },
            ...
            logger_1.logger.warn('Failed to parse AI optimization response, using defaults', { error });
    ...
    parseATSResponse(response) {
        try {
            ...
            logger_1.logger.warn('Failed to parse AI ATS response, using defaults', { error });
    ...
    getMockIndustryTips(industry, role) {
        return [
    ...
    getDefaultOptimizationResult(originalText) {
        return {
            overallScore: 70,
            suggestions: [],
            keywordAnalysis: {
