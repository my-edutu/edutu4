...
if (geminiKey) {
    gemini = new generative_ai_1.GoogleGenerativeAI(geminiKey);
}
if (openaiKey) {
    openai = new openai_1.default({ apiKey: openaiKey });
}
if (cohereKey) {
    cohere = new cohere_ai_1.CohereClient({ token: cohereKey });
}
/**
 ...
 */
async function generateChatResponse(message, ragContext) {
    var _a, _b;
    try {
 ...
 */
function buildEnhancedChatSystemPrompt(ragContext) {
...
`;
    ...
    if (ragContext.userProfile) {
        ...
        prompt += `USER PROFILE:
- Name: ${profile.name}
- Education Level: ${((_a = profile.preferences) === null || _a === void 0 ? void 0 : _a.educationLevel) || 'Not specified'}
- Career Interests: ${((_c = (_b = profile.preferences) === null || _b === void 0 ? void 0 : _b.careerInterests) === null || _c === void 0 ? void 0 : _c.join(', ')) || 'Not specified'}
- Learning Style: ${((_d = profile.preferences) === null || _d === void 0 ? void 0 : _d.learningStyle) || 'Not specified'}
- Skills: ${((_f = (_e = profile.preferences) === null || _e === void 0 ? void 0 : _e.currentSkills) === null || _f === void 0 ? void 0 : _f.join(', ')) || 'Not specified'}
- Career Goals: ${((_h = (_g = profile.preferences) === null || _g === void 0 ? void 0 : _g.careerGoals) === null || _h === void 0 ? void 0 : _h.join(', ')) || 'Not specified'}
- Time Availability: ${((_j = profile.preferences) === null || _j === void 0 ? void 0 : _j.timeAvailability) || 'Not specified'}
...
`;
    ...
    if (ragContext.chatHistory && ragContext.chatHistory.length > 0) {
        ...
        ragContext.chatHistory.slice(-3).forEach((chat) => {
    ...
    if (ragContext.userGoals && ragContext.userGoals.length > 0) {
        prompt += `ACTIVE GOALS:\n`;
        ragContext.userGoals.slice(0, 3).forEach((goal) => {
    ...
    if (ragContext.relevantScholarships && ragContext.relevantScholarships.length > 0) {
        ...
        ragContext.relevantScholarships.slice(0, 5).forEach((scholarship, i) => {
            prompt += `${i + 1}. ${scholarship.title} (${scholarship.provider})\n`;
            if (scholarship.summary)
                prompt += `   Summary: ${scholarship.summary.substring(0, 150)}...\n`;
 ...
 */
function buildRoadmapPrompt(opportunity, userProfile, options) {
...
Current Goals: ${((_f = userProfile.preferences) === null || _f === void 0 ? void 0 : _f.currentGoals) || 'Not specified'}
 ...
 */
function enrichRoadmapData(roadmapData, opportunity, userProfile) {
    return Object.assign(Object.assign({}, roadmapData), { opportunityId: opportunity.id, userId: userProfile.id, difficulty: calculateDifficulty(opportunity, userProfile), estimatedHours: calculateEstimatedHours(roadmapData.milestones), tags: extractRoadmapTags(roadmapData, opportunity), status: 'active', progress: 0, createdBy: 'ai', generatedAt: new Date().toISOString() });
}
/**
 * Generate template-based roadmap as fallback
 */
function generateTemplateRoadmap(opportunity, userProfile) {
    return {
 ...
 */
function generateEnhancedRuleBasedResponse(message, ragContext) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v;
    const lowerMessage = message.toLowerCase();
    // Personalize responses with user name if available
    const userName = ((_a = ragContext.userProfile) === null || _a === void 0 ? void 0 : _a.name) ? `, ${ragContext.userProfile.name}` : '';
...
${ragContext.relevantScholarships.slice(0, 3).map((s, i) => {
                var _a;
                return `${i + 1}. **${s.title}** (${s.provider})
   ${(_a = s.summary) === null || _a === void 0 ? void 0 : _a.substring(0, 120)}...${s.deadline ? `\n   Deadline: ${new Date(s.deadline.toMillis()).toLocaleDateString()}` : ''}`;
            }).join('\n\n')}

Based on your interests in ${((_d = (_c = (_b = ragContext.userProfile) === null || _b === void 0 ? void 0 : _b.preferences) === null || _c === void 0 ? void 0 : _c.careerInterests) === null || _d === void 0 ? void 0 : _d.join(', ')) || 'your field'}, these look particularly promising. Would you like detailed information about any of these, or shall I help you create an application roadmap?`;
        }
        return `Hi${userName}! I'd love to help you find scholarship opportunities. Based on your profile as a ${((_f = (_e = ragContext.userProfile) === null || _e === void 0 ? void 0 : _e.preferences) === null || _f === void 0 ? void 0 : _f.educationLevel) || 'student'} interested in ${((_j = (_h = (_g = ragContext.userProfile) === null || _g === void 0 ? void 0 : _g.preferences) === null || _h === void 0 ? void 0 : _h.careerInterests) === null || _j === void 0 ? void 0 : _j[0]) || 'your field'}, let me search for the most relevant funding opportunities for you.`;
    }
...
${ragContext.userGoals.slice(0, 2).map((g, i) => `${i + 1}. **${g.title}** - ${g.status}`).join('\n')}
...
I can help you create a detailed step-by-step roadmap for any of these goals, or we can work on a new learning path. Which goal would you like to focus on first?`;
        ...
        return `Absolutely${userName}! Creating a personalized roadmap is one of my specialties. Based on your background in ${((_l = (_k = ragContext.userProfile) === null || _k === void 0 ? void 0 : _k.preferences) === null || _l === void 0 ? void 0 : _l.educationLevel) || 'your studies'} and interest in ${((_p = (_o = (_m = ragContext.userProfile) === null || _m === void 0 ? void 0 : _m.preferences) === null || _o === void 0 ? void 0 : _o.careerInterests) === null || _p === void 0 ? void 0 : _p[0]) || 'your field'}, I can help you design a step-by-step plan. What specific goal or opportunity would you like to work towards?`;
    }
    if (lowerMessage.includes('career') || lowerMessage.includes('job')) {
        const interests = ((_r = (_q = ragContext.userProfile) === null || _q === void 0 ? void 0 : _q.preferences) === null || _r === void 0 ? void 0 : _r.careerInterests) || [];
...
What area would you like to explore first?`;
    ...
    if (ragContext.chatHistory && ragContext.chatHistory.length > 0) {
        return `Hi${userName}! I'm here to continue helping you with your educational and career goals. Based on our previous conversation, I remember we were discussing ${(_s = ragContext.chatHistory[0]) === null || _s === void 0 ? void 0 : _s.message.split(' ').slice(0, 5).join(' ')}... 
...
${ragContext.userProfile ? `I see you're a ${((_t = ragContext.userProfile.preferences) === null || _t === void 0 ? void 0 : _t.educationLevel) || 'student'} interested in ${((_v = (_u = ragContext.userProfile.preferences) === null || _u === void 0 ? void 0 : _u.careerInterests) === null || _v === void 0 ? void 0 : _v[0]) || 'your field'}.` : ''} 
 ...
 */
function calculateDifficulty(opportunity, userProfile) {
    var _a;
    // Simple heuristic - can be made more sophisticated
    const requirements = (opportunity.requirements || '').toLowerCase();
    const userLevel = (((_a = userProfile.preferences) === null || _a === void 0 ? void 0 : _a.educationLevel) || '').toLowerCase();
 ...
 */
function calculateEstimatedHours(milestones) {
 ...
 */
function extractRoadmapTags(roadmapData, opportunity) {
    const tags = new Set(['roadmap']);
    // Add opportunity-based tags
    if (opportunity.category)
        tags.add(opportunity.category);
    if (opportunity.provider)
        tags.add(opportunity.provider.toLowerCase());
