...
exports.weeklyDataCleanup = exports.autoModerationCheck = exports.progressStallDetection = exports.monthlyGoalAnalytics = exports.weeklyGoalReminders = exports.dailyAnalyticsGeneration = void 0;
 ...
 */
const dailyAnalyticsGeneration = async (context) => {
...
exports.dailyAnalyticsGeneration = dailyAnalyticsGeneration;
/**
 * Weekly Goal Reminders
 * Runs every Monday at 9 AM UTC to send goal reminders to users
 */
const weeklyGoalReminders = async (context) => {
...
exports.weeklyGoalReminders = weeklyGoalReminders;
/**
 * Monthly Goal Analytics
 * Runs on the 1st of each month to generate detailed goal analytics
 */
const monthlyGoalAnalytics = async (context) => {
    ...
    try {
        ...
        const [goalsCreated, goalsCompleted, activeUsers, marketplaceSubmissions] = await Promise.all([
...
exports.monthlyGoalAnalytics = monthlyGoalAnalytics;
/**
 * Goal Progress Stall Detection
 * Runs daily at 6 PM UTC to identify users with stalled progress
 */
const progressStallDetection = async (context) => {
...
exports.progressStallDetection = progressStallDetection;
/**
 * Marketplace Content Moderation
 * Runs every 4 hours to auto-moderate simple cases
 */
const autoModerationCheck = async (context) => {
...
exports.autoModerationCheck = autoModerationCheck;
/**
 * Cleanup Old Data
 * Runs weekly to clean up old sessions and logs
 */
const weeklyDataCleanup = async (context) => {
...
exports.weeklyDataCleanup = weeklyDataCleanup;
// Helper Functions
async function createGoalReminder(userId, goal) {
    try {
...
async function sendEncouragementNotification(userId, goal) {
    try {
...
async function shouldAutoApproveGoal(goal) {
...
async function shouldAutoRejectGoal(goal) {
...
//# sourceMappingURL=goalsScheduled.js.map